...
function changeWeather(response,temp){
    if(temp <= 0){
        body.style.backgroundImage = 'url("https://images.unsplash.com/photo-1478719059408-592965723cbc?ixid=MnwxMjA3fDB8MHxwaG90[…]fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=712&q=80")';

    }else if(response == "overcast clouds"|| response == "scattered clouds"||response ==" broken clouds"){
        ...
        response == "light rain"|| response == "heavy rain"|| response == " rain"|| response == "moderate rain"){
...
btn.addEventListener('click',function(){
    ...
    if(cityName != ""){
        ...
        let time = new Date();
        // &units=metric
        // const API_KEY = f4bc2673421436c35cd1eb6b052a8556;
        const API = `https://api.openweathermap.org/data/2.5/weather?q=${cityName}&appid=f4bc2673421436c35cd1eb6b052a8556`;
